...
ID=timit-imagenet-$PARTS-$SOLVER-$LAMBDA-$SGD_STEP_SIZE-$SGD_NUM_ITERS-$SGD_MINI_BATCH_FRACTION-`date +"%Y_%m_%d_%H_%M_%S"`

/root/spark/bin/spark-submit \
  --class edu.berkeley.cs.amplab.mlmatrix.TIMIT \
