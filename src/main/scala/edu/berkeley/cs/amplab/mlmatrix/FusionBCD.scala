...
object FusionBCD extends Logging with Serializable {
  ...
  def main(args: Array[String]) {
    ...
    val daisyResiduals = Utils.computeResidualNormsWithL2(daisyTrains, daisyB, daisyXs, lambda)
    val lcsResiduals = Utils.computeResidualNormsWithL2(lcsTrains, lcsB, lcsXs, lambda)
